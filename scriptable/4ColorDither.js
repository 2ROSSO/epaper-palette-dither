...
<div class="control-section">
  <div class="control-row">
    ...
    <div class="segmented" id="presetBtns">
      <button data-w="296" data-h="128" class="active">2.9"</button>
      <button data-w="400" data-h="300">4.2"</button>
    </div>
  </div>
  ...
  <div class="control-row">
    ...
    <div class="segmented" id="colorBtns">
      <button data-mode="grayout" class="active">Gray</button>
      <button data-mode="antisat">AntiSat</button>
      <button data-mode="centroid">Cent</button>
      <button data-mode="illuminant">Illum</button>
    </div>
  </div>
</div>

<!-- Grayout strength (only for Grayout mode) -->
<div class="control-section" id="strengthSection">
  <div class="control-row">
...
<div class="control-section" id="illuminantSection" style="display:none">
  <div class="control-row">
...
(function() {
  ...
  let targetW = 296, targetH = 128;
  let colorMode = 'grayout';
  ...
  function showOriginal() {
    ...
    const scale = Math.min(targetW / sourceImage.width, targetH / sourceImage.height);
    ...
    infoEl.textContent = \`\${sourceImage.width}x\${sourceImage.height} → \${w}x\${h}\`;
